    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while left > 0:        
        ...
        # Otherwise (the input is not a single period):
            ...
            result = isValidWord(word, handcopy, wordList)
            if result == False:
            ...
            # Otherwise (the word is valid):
                ...
                left = calculateHandlen(handcopy)
...
def playGame(wordList):
    ...
    flag = True
    while flag:
        call = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        if call == 'r':
